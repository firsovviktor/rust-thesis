...
mypath = "./output_files"
target_label = "_alpha_0.1_Dimensions_3"
comp_field = "field_re"
...
for in_fname in in_fname_list:
    if (target_label in in_fname):
        ...
        ff_arr = (np.loadtxt(in_fname, usecols=(2, 3, 4, 5), skiprows=1)).T
        ...
        data_dict[int(Nr)] = new_dict #change later
...
#print("data_dict[1025][comp_field][:10]")
#print(data_dict[1025][comp_field][:10])
#print()
...
print("difs")
print (dif_33_65, dif_65_129, dif_129_257, dif_257_513, dif_513_1025, dif_1025_2049, sep='\n')
print ()
